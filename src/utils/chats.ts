...
async function getChatMapFromLocalStorage(): Promise<{tenantId: string, chatMap: Record<string, IChat>}> {
    ...
    const chatMap: Record<string, IChat> = chatListString ? JSON.parse(chatListString) : {};
