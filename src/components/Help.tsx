import { faPaperPlane, faRightFromBracket, faRightToBracket, faScrewdriverWrench } from "@fortawesome/free-solid-svg-icons";
        ...
        <main className="help-display">
            ...
            <ul>
                <li>
                    ...
                    <p>Type something here then press "Enter" or click the "<FontAwesomeIcon icon={faPaperPlane} /> Send" icon (bottom right) to send a message.</p>
                ...
                <li>
                    ...
                    <p>Adding strings to an array is pretty limiting for reproducing various user scenarios. Several tools have been added to the "<FontAwesomeIcon icon={faScrewdriverWrench} /> Tools" menu to the left of the input bar. Click the "<FontAwesomeIcon icon={faScrewdriverWrench} /> Tools" menu button to view a complete list of special utilities and their main usecases.</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p>By default, you will be assigned a GUID name per page load. To send messages with a consistent user id across windows/refreshes, enter a username into the "username" input then "Log in <FontAwesomeIcon icon={faRightToBracket} />". This will cause you to rejoin the session as the given username. Username is stored across page loads. Username can be cleared by clicking "Log out <FontAwesomeIcon icon={faRightFromBracket} />".</p>
                </li>
            </ul>
        </main>
    );
